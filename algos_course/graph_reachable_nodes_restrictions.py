...
there is an edge between nodes ai and bi in the 
tree. You are also given an integer array restricted 
...
class Solution:
    def reachableNodes(self, n: int, edges: list[list[int]], restricted: list[int]) -> int:
        ...
        # Mark nodes in restricted as seen:
        for node in restricted:
            seen.add(node)

        # create a dfs function, that returns 0 if in restricted, else 1
