...
1. 0 <= i <= s.length - 2
2. s[i] is a lower-case letter and s[i + 1] is the same 
...
Return the string after making it good. The answer is 
guaranteed to be unique under the given constraints.
